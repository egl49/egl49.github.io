...
<div class="skills-accordion-container" style="margin-top: 30px;">
  ...
  {% for entry in sorted_skills %}
    ...
    <details id="{{ skill | slugify }}" class="card skill-details-wrapper" style="border: 1px solid var(--global-border-color); border-radius: 12px; margin-bottom: 16px; padding: 0; overflow: hidden; background-color: var(--global-card-bg); color: var(--global-text-color); box-shadow: none; transition: border-color 0.2s ease;">
      
      <summary class="skill-summary-header" style="padding: 18px 24px; font-size: 1.1em; font-weight: 600; cursor: pointer; display: flex; justify-content: space-between; align-items: center; list-style: none; outline: none; user-select: none; color: var(--global-text-color);">
      ...
      <div class="skill-dropdown-body" style="padding: 0 24px 24px 24px; border-top: 1px solid var(--global-border-color); display: grid; gap: 12px; background-color: rgba(0, 0, 0, 0.05);">
        ...
        {% for exp in site.data.experiences %}
          {% if exp.skills contains skill %}
            <div class="skill-position-row" style="border: 1px solid var(--global-border-color); border-radius: 8px; padding: 14px 18px; display: flex; justify-content: space-between; align-items: center; background-color: var(--global-card-bg);">
